...
class Environment:
    ...
    def __init__(self, n, fileName="data/WING22_1min_OLHCV.csv", initInvest=0):
        self.n = n
    ...
    def runNext(self, A):
        ...
        if A == -1:                             # limit short
            if self.tradeStatus == 0:           # new trade opened
                self.tradeStatus = -1
                self.entryPrice = C
                self.tradePL = self.entryPrice - Cprime
...
if __name__ == '__main__':
    env = Environment(n=2, fileName="data/WING22/WING22_1min_OLHCV.csv")
